...
import { Sparkles, ArrowRight, Loader2, FolderKanban, Search } from 'lucide-react'
...
const MAX = 500
const EXAMPLES = [
  'I need a classical singer in Mumbai for a weekend event.',
  'Looking for a dance instructor for an online workshop.',
  'Need a photographer in Delhi next month.',
  'Looking for a guitarist for a music collaboration.',
  ...
  return (
    <div className="flex h-full flex-col bg-bg">
      ...
      <div className="no-scrollbar flex-1 overflow-y-auto px-[18px] pt-5" style={{ paddingBottom: 'calc(62px + var(--safe-bottom) + 16px)' }}>
        ...
        <PrimaryButton full disabled={busy} onClick={find} className="mt-2">
